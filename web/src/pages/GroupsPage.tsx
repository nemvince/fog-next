...
export function GroupsPage() {
  ...
  return (
    <div className="p-8">
      ...
      <DataTable table={table} isLoading={isLoading} emptyMessage="No groups defined" />

      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="text-lg font-semibold text-gray-100">Create Group</DialogTitle>
          </DialogHeader>
          <form
