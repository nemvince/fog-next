import { imagesApi, type Image } from '@/api/client'
...
export function ImagesPage() {
  ...
  return (
    <div className="p-8">
      ...
      <DataTable table={table} isLoading={isLoading} emptyMessage="No images defined" />

      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="text-lg font-semibold text-gray-100">Create Image</DialogTitle>
          </DialogHeader>
          <form
