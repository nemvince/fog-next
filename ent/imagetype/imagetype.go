...
const (
	// Label holds the string label denoting the imagetype type in the database.
	Label = "image_type"
	...
	EdgeImages = "images"
	// Table holds the table name of the imagetype in the database.
	Table = "image_types"
	...
	ImagesColumn = "image_type_id"
)

// Columns holds all SQL columns for imagetype fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldDescription,
...
// OrderOption defines the ordering options for the ImageType queries.
